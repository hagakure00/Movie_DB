...
import 'package:moviedb/Pages/DetailSeriePage.dart';
import 'package:moviedb/Utils/colors.dart';

class SerieCard extends StatelessWidget {
  const SerieCard({Key? key, required this.serie, required this.name,})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => DetailSeriePage(serie: serie)));
        },
        child: Stack(
          children: [
            Positioned(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Text(serie.firstTime!.substring(0, 4),
                          style: GoogleFonts.poppins(
                              textStyle: const TextStyle(
                                  color: white,
                                  fontSize: 14,
                    ...
                    Container(
                        ...
                        child: Text(serie.langue.toString(),
                            style: GoogleFonts.poppins(
                                textStyle: const TextStyle(
                                    color: white,
                                    fontSize: 14,
